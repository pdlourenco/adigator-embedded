...
% returns [Grd, Fun] - the full gradient and the value (C-6 order) - from ONE
% forward and ONE reverse sweep, independent of the number of variables. The derivative
...
x = randn(n,1);
w = 0.5 + rand(n,1);
[g,y] = lse_cost_RGrd(x,w);   % C-6 order: [Grd, Fun]
