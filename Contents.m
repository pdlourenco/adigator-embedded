...
% adigatorDerivativeConventions.m - the authoritative derivative-shape and
%                              output conventions (reference, not executable)
...
% embedding - the embeddable-mode pipeline (inline/classic code generation
%             for MATLAB Coder / Embedded Coder)
