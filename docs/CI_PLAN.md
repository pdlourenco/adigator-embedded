...
| REQ-T-11 | TS-I-12 (Hessian-nonzeros/`HessianLocs` + the `Grd` name fix, R25/#99); TS-I-25 (CSC respelling, ADR-0030); phase-2 support-matrix + per-level selection *(planned, R25)* |
| REQ-C-01 | TS-U-01 |
| REQ-C-02 | TS-U-02 |
| REQ-C-03 | TS-U-03 |
