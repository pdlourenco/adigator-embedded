...
| REQ-T-08 | TS-S-01 |
| REQ-T-09 | TS-S-04 |
| REQ-T-10 | TS-S-06 (rolled-form ERT acceptance, #89); TS-S-02, TS-S-04 (plain-`lib` sites migrate to the ERT `ecoder` target under R20; issue #80) |
| REQ-C-01 | TS-U-01 |
| REQ-C-02 | TS-U-02 |
| REQ-C-03 | TS-U-03 |
