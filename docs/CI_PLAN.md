...
|-------------|-------------------------|
| REQ-T-01 | TS-I-01, TS-S-01, TS-I-13, TS-I-14, TS-I-15, TS-I-26 (zero/linear-objective Hessian, B32), TS-I-27 (@cadastruct fallback naming, B29-B31/B33-B34), TS-I-28 (specialized trip count, B36); TS-I-04 *(planned)*, TS-I-10 *(planned, R22)*, TS-I-25 |
...
| REQ-T-10 | TS-S-06 (rolled-form ERT acceptance, #89), TS-S-09 (stack overhead vs hand-written, ADR-0035); TS-S-02 migrated to the ERT `ecoder` target (#92); TS-S-04 (MC oracle) spec'd born-ERT (ADR-0014 amended, R20c; oracle implementation is R15); issue #80 |
