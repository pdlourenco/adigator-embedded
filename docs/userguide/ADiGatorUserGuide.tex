...
{\bf JAC\_OUTPUT} & \texttt{'matrix'} / \texttt{'nonzeros'} & {\bf (v1.5 fork)} A first-derivative-level-only alias of \texttt{DER\_OUTPUT} (\texttt{adigatorGenJacFile}); it sets the Jacobian/gradient form and never affects a Hessian. Prefer \texttt{DER\_OUTPUT}. \\ \hline
