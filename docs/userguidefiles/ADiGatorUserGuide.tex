...
{\bf EMBED\_MODE} & \texttt{'c'} & {\bf (v1.5 fork)} {\bf C}lassic. The static index/data tables are stored in a \texttt{.mat} file, loaded at runtime into a global variable. Not suitable for embedded code generation. (default) \\ \cline{2-3}
...
{\bf SLIM\_EMBED} & 0 & {\bf (v1.5 fork)} No slimming (default). \\ \cline{2-3}
