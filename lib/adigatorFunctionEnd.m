...
ADiGator_genMatPath = ADIGATOR.PRINT.FILEPATHS.mat; %v2.0 - get full path
...
if ~exist(ADiGator_genMatPath,'file') % v2.0 - the mat file can be in a different folder than the calling dir
